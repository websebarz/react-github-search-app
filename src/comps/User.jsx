export default function User({ currUser }) {
  return (
    <div className="flex flex-col p-6 w-[90%] bg-[#fff] mr-auto ml-auto rounded-lg shadow-lg">
      ...
      <div className="flex w-[279px] h-[85px] mt-6 justify-between bg-[#F6F8FF] text-center p-4 rounded-lg ">
        ...
        <div className="flex flex-col">
          ...
          <span className="mt-2 font-bold">{currUser.followers}</span>
        </div>
        <div className="flex flex-col">
          <span className="text-xs">Following</span>
          <span className="mt-2 font-bold">{currUser.following}</span>
        </div>
      </div>
      <div className="flex flex-col gap-4 mt-4 p-4">
        {currUser.location ? (
          <div className="flex">
            ...
            <span className="ml-4">{currUser.location}</span>
          </div>
        ) : (
          <div className="flex">
            <span>
            ...
            <span className="ml-4 text-[13px] opacity-50 mix-blend-normal">
              Not Available
            </span>
          </div>
        )}
        ...
        {currUser.company ? (
          <div className="flex">
            ...
            <span className="ml-4">{currUser.company}</span>
          </div>
        ) : (
          <div className="flex">
            <span>
